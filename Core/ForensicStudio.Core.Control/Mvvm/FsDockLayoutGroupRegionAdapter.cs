...
public class FsDockLayoutGroupRegionAdapter : RegionAdapterBase<FsDockLayoutGroup>
{
    public FsDockLayoutGroupRegionAdapter(IRegionBehaviorFactory regionBehaviorFactory)
        : base(regionBehaviorFactory)
    {
    }

    protected override void Adapt(IRegion region, FsDockLayoutGroup regionTarget)
    {
    ...
    private FsLayoutPanel GetFsLayoutPanel(FsDockLayoutGroup fsDockLayoutGroup, FrameworkElement content)
    {
        foreach (var baseLayoutItem in fsDockLayoutGroup.Items)
        {
